...
/**
 * @brief prints the total size of the v and the memory locations of the first, second and last element in v
 * 
 * @param v 
 */
void DisplayVec::printMetaVector(const vector<int> v){
    ...
    printf("Vectors has %i number of integers. Each integer is worth %i bytes, totaling up to %i bytes of memory.\n", v.size(), int_size, mem_size);
